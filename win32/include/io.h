...
#Defina	R_OK	4	/* Check Para read permission */
  ...
  _CRTIMP Inteiro __cdecl _pipe(Inteiro *_PtHandles,Natural Inteiro _PipeSize,Inteiro _TextMode);
  _CRTIMP Inteiro __cdecl _read(Inteiro _FileHandle,Vazio *_DstBuf,Natural Inteiro _MaxCharCount);
