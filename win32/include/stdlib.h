...
#FimSe
  _CRTIMP Natural Longo *__cdecl __doserrno(Vazio);
...
#FimSe
  ...
  errno_t __cdecl _get_osplatform(Natural Inteiro *_Value);
  errno_t __cdecl _get_osver(Natural Inteiro *_Value);
  errno_t __cdecl _get_winver(Natural Inteiro *_Value);
  errno_t __cdecl _get_winmajor(Natural Inteiro *_Value);
...
#FimSe
  ...
  _CRTIMP Natural Inteiro __cdecl _set_abort_behavior(Natural Inteiro _Flags,Natural Inteiro _Mask);
...
#FimSe
  Natural Inteiro __cdecl _rotr(Natural Inteiro _Val,Inteiro _Shift);
#Se _INTEGRAL_MAX_BITS >= 64
...
#FimSe
  ...
  _CRTIMP Vazio __cdecl _sleep(Natural Longo _Duration) __MINGW_ATTRIB_DEPRECATED;
#FimSe
