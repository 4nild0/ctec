...
#SeDefinido _POSIX_
  _CRTIMP FILE *__cdecl _fsopen(Imutável Caractere *_Filename, Imutável Caractere *_Mode);
#Senão
  _CRTIMP FILE *__cdecl _fsopen(Imutável Caractere *_Filename, Imutável Caractere *_Mode, Inteiro _ShFlag);
#FimSe
  Vazio __cdecl clearerr(FILE *_File);
  Inteiro __cdecl fclose(FILE *_File);
  _CRTIMP Inteiro __cdecl _fcloseall(Vazio);
#SeDefinido _POSIX_
  FILE *__cdecl fdopen(Inteiro _FileHandle, Imutável Caractere *_Mode);
#Senão
  _CRTIMP FILE *__cdecl _fdopen(Inteiro _FileHandle, Imutável Caractere *_Mode);
#FimSe
...
#FimSe
  _CRTIMP Caractere *__cdecl _tempnam(Imutável Caractere *_DirName, Imutável Caractere *_FilePrefix);
  _CRTIMP Inteiro __cdecl _flushall(Vazio);
  FILE *__cdecl fopen(Imutável Caractere *_Filename, Imutável Caractere *_Mode);
  FILE *fopen64(Imutável Caractere *filename, Imutável Caractere *mode);
  Inteiro __cdecl fprintf(FILE *_File, Imutável Caractere *_Format, ...);
  Inteiro __cdecl fputc(Inteiro _Ch, FILE *_File);
  _CRTIMP Inteiro __cdecl _fputchar(Inteiro _Ch);
  Inteiro __cdecl fputs(Imutável Caractere *_Str, FILE *_File);
  size_t __cdecl fread(Vazio *_DstBuf, size_t _ElementSize, size_t _Count, FILE *_File);
  FILE *__cdecl freopen(Imutável Caractere *_Filename, Imutável Caractere *_Mode, FILE *_File);
  Inteiro __cdecl fscanf(FILE *_File, Imutável Caractere *_Format, ...);
  Inteiro __cdecl fsetpos(FILE *_File, Imutável fpos_t *_Pos);
  ...
  size_t __cdecl fwrite(Imutável Vazio *_Str, size_t _Size, size_t _Count, FILE *_File);
...
#FimSe
  ...
  _CRTIMP FILE *__cdecl _popen(Imutável Caractere *_Command, Imutável Caractere *_Mode);
#Se !Definido(NO_OLDNAMES) && !Definido(popen)
#Defina popen   _popen
#Defina pclose  _pclose
#FimSe
  Inteiro __cdecl printf(Imutável Caractere *_Format, ...);
  Inteiro __cdecl putc(Inteiro _Ch, FILE *_File);
  Inteiro __cdecl putchar(Inteiro _Ch);
  Inteiro __cdecl puts(Imutável Caractere *_Str);
...
#FimSe
  ...
  Inteiro __cdecl scanf(Imutável Caractere *_Format, ...);
  Vazio __cdecl setbuf(FILE *_File, Caractere *_Buffer);
  _CRTIMP Inteiro __cdecl _setmaxstdio(Inteiro _Max);
  _CRTIMP Natural Inteiro __cdecl _set_output_format(Natural Inteiro _Format);
  _CRTIMP Natural Inteiro __cdecl _get_output_format(Vazio);
  Inteiro __cdecl setvbuf(FILE *_File, Caractere *_Buf, Inteiro _Mode, size_t _Size);
  _CRTIMP Inteiro __cdecl _scprintf(Imutável Caractere *_Format, ...);
  Inteiro __cdecl sscanf(Imutável Caractere *_Src, Imutável Caractere *_Format, ...);
  _CRTIMP Inteiro __cdecl _snscanf(Imutável Caractere *_Src, size_t _MaxCount, Imutável Caractere *_Format, ...);
  FILE *__cdecl tmpfile(Vazio);
  Caractere *__cdecl tmpnam(Caractere *_Buffer);
  Inteiro __cdecl ungetc(Inteiro _Ch, FILE *_File);
  Inteiro __cdecl vfprintf(FILE *_File, Imutável Caractere *_Format, va_list _ArgList);
  Inteiro __cdecl vprintf(Imutável Caractere *_Format, va_list _ArgList);
...
# Esqueça snprintf
  ...
  Inteiro __cdecl vsnprintf(Caractere *_DstBuf, size_t _MaxCount, Imutável Caractere *_Format, va_list _ArgList);
  _CRTIMP Inteiro __cdecl _snprintf(Caractere *_Dest, size_t _Count, Imutável Caractere *_Format, ...);
  _CRTIMP Inteiro __cdecl _vsnprintf(Caractere *_Dest, size_t _Count, Imutável Caractere *_Format, va_list _Args);
  Inteiro __cdecl sprintf(Caractere *_Dest, Imutável Caractere *_Format, ...);
  Inteiro __cdecl vsprintf(Caractere *_Dest, Imutável Caractere *_Format, va_list _Args);
#SeNãoDefinido __NO_ISOCEXT  /* externs in libmingwex.a */
  Inteiro __cdecl snprintf(Caractere* s, size_t n, Imutável Caractere*  format, ...);
  __CRT_INLINE Inteiro __cdecl vsnprintf (Caractere* s, size_t n, Imutável Caractere* format, va_list arg) {
    Retorne _vsnprintf ( s, n, format, arg);
  }
  Inteiro __cdecl vscanf(Imutável Caractere * Format, va_list argp);
  Inteiro __cdecl vfscanf (FILE * fp, Imutável Caractere * Format, va_list argp);
  Inteiro __cdecl vsscanf (Imutável Caractere * _Str, Imutável Caractere * Format, va_list argp);
#FimSe
...
# FimSe
# FimSe
  _CRTIMP Inteiro __cdecl _vscprintf(Imutável Caractere *_Format, va_list _ArgList);
...
#Defina _putwchar_nolock(_c) _putwc_nolock((_c), stdout)
  ...
  _CRTIMP size_t __cdecl _fwrite_nolock(Imutável Vazio *_DstBuf, size_t _Size, size_t _Count, FILE *_File);
...
#Defina SYS_OPEN _SYS_OPEN
  ...
  Caractere *__cdecl tempnam(Imutável Caractere *_Directory, Imutável Caractere *_FilePrefix);
  Inteiro __cdecl fcloseall(Vazio);
  FILE *__cdecl fdopen(Inteiro _FileHandle, Imutável Caractere *_Format);
