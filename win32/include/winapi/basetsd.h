...
#Defina ADDRESS_TAG_BIT 0x40000000000ULL
  ...
  Fixo __inline Natural Longo HandleToULong(Imutável Vazio *h) { Retorne((Natural Longo) (ULONG_PTR) h); }
  Fixo __inline Longo HandleToLong(Imutável Vazio *h) { Retorne((Longo) (LONG_PTR) h); }
  Fixo __inline Vazio *ULongToHandle(Imutável Natural Longo h) { Retorne((Vazio *) (UINT_PTR) h); }
  Fixo __inline Vazio *LongToHandle(Imutável Longo h) { Retorne((Vazio *) (INT_PTR) h); }
  Fixo __inline Natural Longo PtrToUlong(Imutável Vazio *p) { Retorne((Natural Longo) (ULONG_PTR) p); }
  Fixo __inline Natural Inteiro PtrToUint(Imutável Vazio *p) { Retorne((Natural Inteiro) (UINT_PTR) p); }
  Fixo __inline Natural Curto PtrToUshort(Imutável Vazio *p) { Retorne((Natural Curto) (Natural Longo) (ULONG_PTR) p); }
  Fixo __inline Longo PtrToLong(Imutável Vazio *p) { Retorne((Longo) (LONG_PTR) p); }
  Fixo __inline Inteiro PtrToInt(Imutável Vazio *p) { Retorne((Inteiro) (INT_PTR) p); }
  Fixo __inline Curto PtrToShort(Imutável Vazio *p) { Retorne((Curto) (Longo) (LONG_PTR) p); }
  Fixo __inline Vazio *IntToPtr(Imutável Inteiro i) { Retorne((Vazio *)(INT_PTR)i); }
  Fixo __inline Vazio *UIntToPtr(Imutável Natural Inteiro ui) { Retorne((Vazio *)(UINT_PTR)ui); }
  Fixo __inline Vazio *LongToPtr(Imutável Longo l) { Retorne((Vazio *)(LONG_PTR)l); }
  Fixo __inline Vazio *ULongToPtr(Imutável Natural Longo ul) { Retorne((Vazio *)(ULONG_PTR)ul); }
...
#Defina Handle64ToHandle(h) (Ptr64ToPtr(h))
  ...
  Fixo __inline Vazio *Ptr32ToPtr(Imutável Vazio *p) { Retorne (Vazio *)p; }
  Fixo __inline Vazio *Handle32ToHandle(Imutável Vazio *h) { Retorne((Vazio *) h); }
  Fixo __inline Vazio *PtrToPtr32(Imutável Vazio *p) { Retorne((Vazio *) (ULONG_PTR) p); }
...
#Defina ULongToPtr(ul) ((VOID *)(ULONG_PTR)((Natural Longo)ul))
  ...
  Fixo __inline Vazio *PtrToPtr64(Imutável Vazio *p) { Retorne((Vazio *) (ULONG_PTR)p); }
  Fixo __inline Vazio *Ptr64ToPtr(Imutável Vazio *p) { Retorne((Vazio *) (ULONG_PTR) p); }
  Fixo __inline Vazio *HandleToHandle64(Imutável Vazio *h) { Retorne((Vazio *) h); }
  Fixo __inline Vazio *Handle64ToHandle(Imutável Vazio *h) { Retorne((Vazio *) (ULONG_PTR) h); }
