...
#Defina RotateRight16 _rotr16
    ...
    Natural Caractere __cdecl _rotl8(Natural Caractere Value,Natural Caractere Shift);
    Natural Curto __cdecl _rotl16(Natural Curto Value,Natural Caractere Shift);
    Natural Caractere __cdecl _rotr8(Natural Caractere Value,Natural Caractere Shift);
    Natural Curto __cdecl _rotr16(Natural Curto Value,Natural Caractere Shift);
#FimSe
...
#Defina RotateRight64 _rotr64
    ...
    Natural Inteiro __cdecl _rotl(Natural Inteiro Value,Inteiro Shift);
    Natural __int64 __cdecl _rotl64(Natural __int64 Value,Inteiro Shift);
    Natural Inteiro __cdecl _rotr(Natural Inteiro Value,Inteiro Shift);
    Natural __int64 __cdecl _rotr64(Natural __int64 Value,Inteiro Shift);
#SeDefinido __cplusplus
  }
#FimSe
...
#Defina GetCallersEflags() __getcallerseflags()
    ...
    Natural __int32 __getcallerseflags(VOID);
