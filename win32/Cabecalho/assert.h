...
Externo Vazio __cdecl _wassert(Constante wchar_t *_Message,Constante wchar_t *_File,Natural _Line);
Externo Vazio __cdecl _assert(Constante Caractere *, Constante Caractere *, Natural);
