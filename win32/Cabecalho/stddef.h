...
Tipo TIPO_TAMANHO size_t;
Tipo DIFERENÇA_ENTRE_PONTEIROS ssize_t;
Tipo CARACTERE_UNICODE wchar_t;
Tipo DIFERENÇA_ENTRE_PONTEIROS ptrdiff_t;
Tipo DIFERENÇA_ENTRE_PONTEIROS intptr_t;
Tipo TIPO_TAMANHO uintptr_t;
